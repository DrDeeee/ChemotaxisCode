...
public class SimGUIPanel {
    ...
    public void create(){
        ...
        JTextField jtConc = new JTextField(Double.toString(ChemicalEnvironment.concSource1));
        ...
        */
        ...
        p.add(new JLabel("k1", JLabel.TRAILING));
        ...
        if(iR==JOptionPane.OK_OPTION){
            ...
            ChemicalEnvironment.concSource1 = Double.parseDouble(jtConc.getText());
